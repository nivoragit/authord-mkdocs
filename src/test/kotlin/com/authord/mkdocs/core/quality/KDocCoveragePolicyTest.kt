...
class KDocCoveragePolicyTest {
    private val phase2ApiSurfaceFiles = listOf(
        "src/main/kotlin/com/authord/mkdocs/ports/topic/MkDocsConfigGateway.kt",
        "src/main/kotlin/com/authord/mkdocs/ports/topic/DocsFileGateway.kt",
        "src/main/kotlin/com/authord/mkdocs/ports/topic/TreeSyncOrchestrator.kt",
        "src/main/kotlin/com/authord/mkdocs/ports/topic/InstanceRegistryPort.kt",
        "src/main/kotlin/com/authord/mkdocs/ui/intellij/TopicTreeApplicationService.kt",
        "src/main/kotlin/com/authord/mkdocs/ui/intellij/TopicTreeUiService.kt",
        "src/main/kotlin/com/authord/mkdocs/ui/intellij/TopicTreeSyncOrchestratorService.kt",
        "src/main/kotlin/com/authord/mkdocs/ui/intellij/TopicTreeWatcherCoordinator.kt",
        "src/main/kotlin/com/authord/mkdocs/runtime/MkDocsYamlGateway.kt",
    )

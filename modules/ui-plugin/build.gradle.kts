...
tasks.named<JacocoCoverageVerification>("jacocoTestCoverageVerification") {
    violationRules {
        rule {
            element = "CLASS"
            includes = listOf(
                "com.authord.mkdocs.ui.ActivationErrorPresenter*",
                "com.authord.mkdocs.ui.ActivationFailureReason*",
                "com.authord.mkdocs.ui.ActivationResult*",
                "com.authord.mkdocs.ui.DefaultTopicTreeApplicationService*",
                "com.authord.mkdocs.ui.DefaultTopicTreeUiService*",
                "com.authord.mkdocs.ui.DocsExplorerService*",
                "com.authord.mkdocs.ui.DocsFileSelectedEvent*",
                "com.authord.mkdocs.ui.DocsFileSelectionPublisher*",
                "com.authord.mkdocs.ui.FeatureFlagPolicyService*",
                "com.authord.mkdocs.ui.InMemoryInstanceRegistryPort*",
                "com.authord.mkdocs.ui.NavigationCoordinator*",
                "com.authord.mkdocs.ui.NavigationResult*",
                "com.authord.mkdocs.ui.NoOpDocsFileGateway*",
                "com.authord.mkdocs.ui.NoOpMkDocsConfigGateway*",
                "com.authord.mkdocs.ui.NoOpTreeSyncOrchestrator*",
                "com.authord.mkdocs.ui.PluginCompositionRoot*",
                "com.authord.mkdocs.ui.PreviewNavigationFailureHandler*",
                "com.authord.mkdocs.ui.PreviewPaneCoordinator*",
                "com.authord.mkdocs.ui.PreviewPaneState*",

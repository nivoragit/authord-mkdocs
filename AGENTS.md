...
- 002-intellij-mkdocs-mvp: Added Kotlin 1.9+ on JVM 21 (IntelliJ Platform plugin target) + IntelliJ Platform SDK (PSI, ToolWindow, Disposable lifecycle), embedded browser component, `uv` CLI, `mkdocs` CLI
